  ...
  return (
    <div className="bg-[#F6F6FB] p-8 font-dm min-h-full overflow-y-auto">
      <div className="flex items-start justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-[#242450]">Time Off & Leave</h1>
          <p className="text-sm text-[#5777AB] mt-0.5">Team leave and time off tracker</p>
        </div>
        <button
      ...
      {activeTab === 'list' && <WhosOutView refresh={refresh} showAllStatuses />}
