        ...
        <nav className="flex-1 py-3 overflow-y-auto" style={{ scrollbarWidth: 'none' }}>
          ...
          {onAddSection && (
            <button
              ...
              className="w-full flex items-center gap-1.5 px-3 py-2 mt-2 text-[11px] font-semibold text-white/40 hover:text-white border border-dashed border-white/15 hover:border-white/30 rounded-lg transition-colors"
            >
