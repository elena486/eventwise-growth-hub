export const MEMBERS = [
  ...
  },
  {
    ...
    questions: [
      ...
      { id: 'q3', label: 'Lead to Demo Conversion %', type: 'number', suffix: '%' },
      { id: 'q5', label: 'Demo to Sale Conversion %', type: 'number', suffix: '%' },
      { id: 'q4', label: 'Forecast vs target (£)', type: 'number', prefix: '£' },
    ],
    kpi1: { questionId: 'q1', label: 'Pipeline added', target: 20000, prefix: '£' },
    kpi2: { questionId: 'q3', label: 'Lead to Demo Conversion', target: 20, suffix: '%' },
    kpi3: { questionId: 'q5', label: 'Demo to Sale Conversion', target: 20, suffix: '%' },
    qualitativeIds: [],
    duplicateLastMonth: false,
  },
  {
    ...
    questions: [
      ...
      { id: 'q_shipped', label: 'One thing shipped this week', type: 'text', placeholder: 'A process, tool, asset, or update completed this week...' },
